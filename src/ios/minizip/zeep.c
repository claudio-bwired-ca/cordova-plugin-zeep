...
extern zipFile ZEXPORT zeepOpen4(const void *pathname, int append, ZPOS64_T disk_size, zipcharpc *globalcomment,
                                zlib_filefunc64_32_def *pzlib_filefunc64_32_def)
{
    ...
    if (pzlib_filefunc64_32_def == NULL)
        fillzeep_fopen64_filefunc(&ziinit.z_filefunc.zfile_func64);
    else
...
extern zipFile ZEXPORT zeepOpen2(const char *pathname, int append, zipcharpc *globalcomment,
                                zlib_filefunc_def *pzlib_filefunc32_def)
{
    if (pzlib_filefunc32_def != NULL) {
        zlib_filefunc64_32_def zlib_filefunc64_32_def_fill;
        fill_zeeplib_filefunc64_32_def_from_filefunc32(&zlib_filefunc64_32_def_fill, pzlib_filefunc32_def);
        return zeepOpen4(pathname, append, 0, globalcomment, &zlib_filefunc64_32_def_fill);
    }
    return zeepOpen4(pathname, append, 0, globalcomment, NULL);
}

extern zipFile ZEXPORT zeepOpen2_64(const void *pathname, int append, zipcharpc *globalcomment,
...
extern zipFile ZEXPORT zeepOpen3(const char *pathname, int append, ZPOS64_T disk_size, zipcharpc *globalcomment,
                                zlib_filefunc_def *pzlib_filefunc32_def)
{
    if (pzlib_filefunc32_def != NULL) {
        zlib_filefunc64_32_def zlib_filefunc64_32_def_fill;
        fill_zeeplib_filefunc64_32_def_from_filefunc32(&zlib_filefunc64_32_def_fill, pzlib_filefunc32_def);
        return zeepOpen4(pathname, append, disk_size, globalcomment, &zlib_filefunc64_32_def_fill);
    }
    return zeepOpen4(pathname, append, disk_size, globalcomment, NULL);
}

extern zipFile ZEXPORT zeepOpen3_64(const void *pathname, int append, ZPOS64_T disk_size, zipcharpc *globalcomment,
                                   zlib_filefunc64_def *pzlib_filefunc_def)
{
    if (pzlib_filefunc_def != NULL) {
        zlib_filefunc64_32_def zlib_filefunc64_32_def_fill;
...
extern zipFile ZEXPORT zeepOpen(const char *pathname, int append)
{
    return zeepOpen3((const void *)pathname, append, 0, NULL, NULL);
}

extern zipFile ZEXPORT zeepOpen64(const void *pathname, int append)
{
    return zeepOpen3(pathname, append, 0, NULL, NULL);
}

extern int ZEXPORT zeepOpenNewFileInZip4_64(zipFile file, const char *filename, const zip_fileinfo *zipfi,
...
extern int ZEXPORT zeepOpenNewFileInZip4(zipFile file, const char *filename, const zip_fileinfo *zipfi,
                                        const void *extrafield_local, uInt size_extrafield_local, const void *extrafield_global,
...
{
    return zeepOpenNewFileInZip4_64(file, filename, zipfi, extrafield_local, size_extrafield_local,
...
extern int ZEXPORT zeepOpenNewFileInZip3(zipFile file, const char *filename, const zip_fileinfo *zipfi,
                                        const void *extrafield_local, uInt size_extrafield_local, const void *extrafield_global,
                                        uInt size_extrafield_global, const char *comment, int method, int level, int raw, int windowBits,
...
extern int ZEXPORT zeepOpenNewFileInZip3_64(zipFile file, const char *filename, const zip_fileinfo *zipfi,
                                           const void *extrafield_local, uInt size_extrafield_local, const void *extrafield_global,
                                           uInt size_extrafield_global, const char *comment, int method, int level, int raw, int windowBits,
...
extern int ZEXPORT zeepOpenNewFileInZip2(zipFile file, const char *filename, const zip_fileinfo *zipfi,
                                        const void *extrafield_local, uInt size_extrafield_local, const void *extrafield_global,
...
extern int ZEXPORT zeepOpenNewFileInZip2_64(zipFile file, const char *filename, const zip_fileinfo *zipfi,
                                           const void *extrafield_local, uInt size_extrafield_local, const void *extrafield_global,
...
extern int ZEXPORT zeepOpenNewFileInZip64(zipFile file, const char *filename, const zip_fileinfo *zipfi,
                                         const void *extrafield_local, uInt size_extrafield_local, const void *extrafield_global,
...
extern int ZEXPORT zeepOpenNewFileInZip(zipFile file, const char *filename, const zip_fileinfo *zipfi,
                                       const void *extrafield_local, uInt size_extrafield_local, const void *extrafield_global,
...
extern int ZEXPORT zeepWriteInFileInZip(zipFile file, const void *buf, unsigned int len)
{
    zip64_internal *zi;
    int err = ZIP_OK;
...
extern int ZEXPORT zeepCloseFileInZipRaw(zipFile file, uLong uncompressed_size, uLong crc32)
{
    return zeepCloseFileInZipRaw64(file, uncompressed_size, crc32);
}

extern int ZEXPORT zeepCloseFileInZipRaw64(zipFile file, ZPOS64_T uncompressed_size, uLong crc32)
{
    zip64_internal *zi;
...
extern int ZEXPORT zeepCloseFileInZip(zipFile file)
{
    return zeepCloseFileInZipRaw(file, 0, 0);
}

extern int ZEXPORT zeepClose(zipFile file, const char *global_comment)
{
    zip64_internal *zi;
    int err = 0;
